...
export const RoutedContent = () => {
    return (
        <Switch>
            ...
            <Route component={ Calendar } path="/corpo/calendar" />
            <Route path="/corpo/analytics" exact component={Analytics} />
            <Route path="/corpo/financial" exact component={Financial} />
            <Route path="/corpo/clientes/criar" exact component={Clients} />
